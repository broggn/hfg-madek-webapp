    ...
    context 'when resource is a media entry' do
      context 'when logged in user is an owner' do
        ...
        it 'renders template' do
          ...
          expect(response).to be_success
          expect(response).to render_template 'media_entries/create_temporary_url'
        end
        ...
        it 'assigns presenter' do
          ...
          expect(assigns[:get]).to be_instance_of(
            Presenters::MediaEntries::MediaEntryTemporaryUrlShow)
        end
    ...
    context 'when resource is a collection' do
      ...
      context 'when logged in user is an owner' do
        ...
        it 'renders template' do
          ...
          expect(response).to be_success
          expect(response).to render_template 'collections/create_temporary_url'
        end
        ...
        it 'assigns presenter' do
          ...
          expect(assigns[:get]).to be_instance_of(
            Presenters::Collections::CollectionTemporaryUrlShow)
        end
      end

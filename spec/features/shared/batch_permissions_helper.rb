...
module BatchPermissionsHelper
  ...
  def check_batch_permissions_results(resource_class)
    ...
    expect(@case_1_user_permission_1.get_metadata_and_previews).to be == case_1_user_permission_1_dup.get_metadata_and_previews
    expect(@case_1_user_permission_2.get_metadata_and_previews).to be == case_1_user_permission_2_dup.get_metadata_and_previews
    ...
    if resource_class == MediaEntry
      ...
      expect(@case_2_group_permission_1.get_metadata_and_previews).to be == case_2_group_permission_1_dup.get_metadata_and_previews
      expect(@case_2_group_permission_2.get_metadata_and_previews).to be == case_2_group_permission_2_dup.get_metadata_and_previews
      ...
      expect(@case_2_api_client_permission_1.get_metadata_and_previews).to be == case_2_api_client_permission_1_dup.get_metadata_and_previews
      expect(@case_2_api_client_permission_2.get_metadata_and_previews).to be == case_2_api_client_permission_2_dup.get_metadata_and_previews
    end
    ...
    expect(@case_3_user_permission_1.get_metadata_and_previews).to be == case_3_user_permission_1_dup.get_metadata_and_previews
    expect(@case_3_user_permission_2.get_metadata_and_previews).to be == case_3_user_permission_2_dup.get_metadata_and_previews
    ...
    expect(@case_5_api_client_permission_1.get_metadata_and_previews).to be == false
    expect(@case_5_api_client_permission_2.get_metadata_and_previews).to be == false
    ...
    expect(@case_8_user_permission_1.get_metadata_and_previews).to be == case_8_user_permission_1_dup.get_metadata_and_previews
    ...
    # CASE 11
    expect { @case_11_user_permission_1.reload }.to raise_error ActiveRecord::RecordNotFound
    expect { @case_11_user_permission_2.reload }.to raise_error ActiveRecord::RecordNotFound
    expect { @case_11_group_permission_1.reload }.to raise_error ActiveRecord::RecordNotFound
    expect { @case_11_group_permission_2.reload }.to raise_error ActiveRecord::RecordNotFound

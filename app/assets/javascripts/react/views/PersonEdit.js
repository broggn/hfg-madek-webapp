          ...
          >
            ...
            <div className='row'>
              ...
              <div className='ui-actions mtm'>
                ...
                />
                <Button
                  href={actions.cancel.url}
                  className={cx('button', { disabled: isSaving })}
        ...
        <div className='row' key={index}>
          <div className='col1of2'>
            <div className='ui-form-group rowed pan' style={divStyle}>
              <button
                type='button'
                onClick={(e) => handleUriRemove(e, index)}
                className='mrx button'
              >
                <Icon i='trash' />
              </button>
              <input

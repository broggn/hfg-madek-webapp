...
class CustomDatePicker extends React.Component {
  ...
  _getMonthText () {
    return this._monthTexts()[this.props.passedState.month]
  }

  _getYear() {
    return this.props.passedState.year
  }
  ...
  _renderNumber (index, row, rowCount, col, colCount) {
    ...
    var today = currentYear == this.props.passedState.year && currentMonth == this.props.passedState.month && currentDay == index
  ...
  render () {
    ...
    return (
      ...
      <div ref={(ref) => this.reference = ref} style={{display: 'inline-block'}}>

...
class BoxPeopleNewWidget extends React.Component {
  ...
  renderTabs() {
    ...
    // var renderLi = (t) => {
    //   return (
    //     <li className={cx('ui-tabs-item mll pls', {active: newWidget.selected == t})}>
    //       <a
    //         onClick={(e) => this.props.trigger(this.props.component, {action: 'new-widget-tab', tab: t})}
    //       >
    //         {tabLabels(t)}
    //       </a>
    //     </li>

...
class BoxBatchDatumPeople extends React.Component {
    ...
    if(k.id) {
      ...
      return (
        <span key={i} style={{fontStyle: 'italic', marginRight: '10px', color: '#aaa'}}>
          ...
          {k.first_name + ' ' + k.last_name + ' (' + k.pseudonym + ')'}
        </span>
      )
  ...
  renderNewWidget() {
    ...
    //
    // var renderWidget = () => {
    //   var newWidget = this.props.metaKeyForm.data.newWidget
    //   if(!newWidget.open) {
    //     return null
    //   }
    //
    ...
    //       <div style={{}}>
    //         <div>
    //           <div style={{width: '50%'}}>Firstname:</div>
    ...
    //       <a
    //         onClick={(e) => this.props.trigger(this.props.metaKeyForm, {action: 'new-widget'})}
